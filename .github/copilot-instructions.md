...
- Los proyectos están ubicados en el repositorio `F:\Documents\Visual Studio 18\Projects\GoldBusiness` en la rama `master` y se despliegan en la Azure Web App 'goldbusinesswebapi-dev' en el grupo de recursos 'rg-goldbusiness-dev'.
