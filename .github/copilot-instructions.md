...
- Al solicitar la barra lateral 'Inicio', usa un controlador `onHeaderClick(item)` que navegue a la ruta si el elemento tiene una ruta y alterna la expansión si tiene hijos; preserva el tamaño del markup/div. Establece la ruta 'Inicio' a '/inicio' para que coincida con la barra de navegación.
