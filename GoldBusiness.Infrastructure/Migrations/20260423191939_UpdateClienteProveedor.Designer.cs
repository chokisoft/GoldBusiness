...
namespace GoldBusiness.Infrastructure.Migrations
{
    ...
    [Migration("20260423191939_UpdateClienteProveedor")]
    partial class UpdateClienteProveedor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldBusiness.Domain.Entities.Cliente", b =>
                {
                    ...
                    b.Property<int?>("TipoIdentificadorFiscal")
                        .HasColumnType("int");

                    b.Property<bool>("ValidarIdentificadorFiscal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("GoldBusiness.Domain.Entities.SystemConfiguration", b =>
                {
                    ...
                    b.Property<int>("FormaJuridicaId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IvaInternacional")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("RegistradaIva")
                        .HasColumnType("bit");

                    b.Property<decimal>("TasaIvaDefecto")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("GoldBusiness.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("GoldBusiness.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("GoldBusiness.Domain.Entities.SystemConfiguration", b =>
                {
                    ...
                    b.HasOne("GoldBusiness.Domain.Entities.FormaJuridica", "FormaJuridica")
                        .WithMany()
                        .HasForeignKey("FormaJuridicaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("GoldBusiness.Domain.Translation.FormaJuridicaTranslation", b =>
                {
                    b.HasOne("GoldBusiness.Domain.Entities.FormaJuridica", null)
                        .WithMany("Translations")
                        .HasForeignKey("FormaJuridicaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_FormaJuridicaTranslation_FormaJuridica");
                });
