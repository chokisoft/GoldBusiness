        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcion = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    IdentificadorFiscal = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    TipoIdentificadorFiscal = table.Column<int>(type: "int", nullable: true),
                    RegimenFiscal = table.Column<int>(type: "int", nullable: true),
                    TasaIva = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    ExentoIva = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    Extranjero = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CodigoPaisIso = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    ValidarIdentificadorFiscal = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    InversionSujetoPasivo = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentificadorFiscal = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    TipoIdentificadorFiscal = table.Column<int>(type: "int", nullable: false),
                    RegimenFiscal = table.Column<int>(type: "int", nullable: false),
                    TasaIvaDefecto = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    RegistradaIva = table.Column<bool>(type: "bit", nullable: false),
                    IvaInternacional = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodigoPostal_Municipio_Codigo_Cancelado",
                table: "CodigoPostal",
                columns: new[] { "MunicipioId", "Codigo", "Cancelado" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CodigoPostal_MunicipioId",
                table: "CodigoPostal",
                column: "MunicipioId");
