...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    'localidad.tipo.almacen': { 'es': 'Almacén', 'en': 'Warehouse', 'pt': 'Armazém', 'de': 'Lager', 'fr': 'Entrepôt' },
    'localidad.tipo.puntoVenta': { 'es': 'Punto de Venta', 'en': 'Point of Sale', 'pt': 'Ponto de Venda', 'de': 'Verkaufsstelle', 'fr': 'Point de Vente' },
    'localidad.tipo.areaRecepcion': { 'es': 'Área de Recepción', 'en': 'Receiving Area', 'pt': 'Área de Recepção', 'de': 'Wareneingang', 'fr': 'Zone de Réception' },
    'localidad.tipo.areaDespacho': { 'es': 'Área de Despacho', 'en': 'Dispatch Area', 'pt': 'Área de Expedição', 'de': 'Versandbereich', 'fr': 'Zone d\'Expédition' },
    'localidad.tipo.produccion': { 'es': 'Producción', 'en': 'Production', 'pt': 'Produção', 'de': 'Produktion', 'fr': 'Production' },
    'localidad.tipo.transito': { 'es': 'Tránsito', 'en': 'Transit', 'pt': 'Trânsito', 'de': 'Transit', 'fr': 'Transit' },
    'localidad.tipo.cuarentena': { 'es': 'Cuarentena', 'en': 'Quarantine', 'pt': 'Quarentena', 'de': 'Quarantäne', 'fr': 'Quarantaine' },
    'localidad.tipo.consignacion': { 'es': 'Consignación', 'en': 'Consignment', 'pt': 'Consignação', 'de': 'Konsignation', 'fr': 'Consignation' },
    'localidad.tipo.devoluciones': { 'es': 'Devoluciones', 'en': 'Returns', 'pt': 'Devoluções', 'de': 'Rückgaben', 'fr': 'Retours' },
    'localidad.tipo.obsoletos': { 'es': 'Obsoletos', 'en': 'Obsolete', 'pt': 'Obsoletos', 'de': 'Obsolet', 'fr': 'Obsolètes' },
    'localidad.tipo.gerencia': { 'es': 'Gerencia', 'en': 'Management', 'pt': 'Gerência', 'de': 'Verwaltung', 'fr': 'Direction' },
    'localidad.tipo.administrativa': { 'es': 'Administrativa', 'en': 'Administrative', 'pt': 'Administrativa', 'de': 'Verwaltungsbereich', 'fr': 'Administrative' },
    'localidad.codigo': { 'es': 'Código', 'en': 'Code', 'pt': 'Código', 'de': 'Code', 'fr': 'Code' },
    'localidad.capacidades': { 'es': 'Capacidades Operativas', 'en': 'Operational Capabilities', 'pt': 'Capacidades Operacionais', 'de': 'Operative Kapazitäten', 'fr': 'Capacités Opérationnelles' },
    ...
    'localidad.cuentasContablesHelp': { 'es': 'Descripción y ayuda sobre las cuentas contables asociadas a esta localidad', 'en': 'Description and help about the accounting accounts associated with this locality', 'pt': 'Descrição e ajuda sobre as contas contábeis associadas a esta localidade', 'de': 'Beschreibung und Hilfe zu den Buchhaltungskonten, die mit diesem Standort verbunden sind', 'fr': 'Description et aide concernant les comptes comptables associés à cette localité' },
    ...
    'localidad.formEditSubtitle': { 'es': 'Modifique los datos de la localidad operativa', 'en': 'Update the operational locality data', 'pt': 'Modifique os dados da localidade operacional', 'de': 'Bearbeiten Sie die Daten des operativen Standorts', 'fr': 'Modifiez les données de la localité opérationnelle' },
    'localidad.formNewSubtitle': { 'es': 'Cree una nueva ubicación operativa según estándares ERP', 'en': 'Create a new operational location following ERP standards', 'pt': 'Crie uma nova localização operacional segundo os padrões ERP', 'de': 'Erstellen Sie einen neuen operativen Standort nach ERP-Standards', 'fr': 'Créez un nouvel emplacement opérationnel selon les standards ERP' },
    'localidad.selectEstablecimiento': { 'es': 'Seleccione un establecimiento', 'en': 'Select an establishment', 'pt': 'Selecione um estabelecimento', 'de': 'Wählen Sie einen Betrieb', 'fr': 'Sélectionnez un établissement' },
    'localidad.establecimientoHelp': { 'es': 'Establecimiento al que pertenece esta localidad', 'en': 'Establishment to which this locality belongs', 'pt': 'Estabelecimento ao qual esta localidade pertence', 'de': 'Betrieb, zu dem dieser Standort gehört', 'fr': 'Établissement auquel cette localité appartient' },
    'localidad.placeholderCodigo': { 'es': 'Ej: 000000001', 'en': 'Ex: 000000001', 'pt': 'Ex: 000000001', 'de': 'Bsp: 000000001', 'fr': 'Ex: 000000001' },
    'localidad.codigoHelp': { 'es': 'Código único de 9 caracteres (solo lectura en edición)', 'en': 'Unique 9-character code (read-only while editing)', 'pt': 'Código único de 9 caracteres (somente leitura na edição)', 'de': 'Eindeutiger 9-stelliger Code (im Bearbeitungsmodus schreibgeschützt)', 'fr': 'Code unique de 9 caractères (lecture seule en édition)' },
    'localidad.placeholderDescripcion': { 'es': 'Ej: Almacén Central - Planta Baja', 'en': 'Ex: Central Warehouse - Ground Floor', 'pt': 'Ex: Armazém Central - Piso Térreo', 'de': 'Bsp: Zentrallager - Erdgeschoss', 'fr': 'Ex: Entrepôt central - Rez-de-chaussée' },
    'localidad.descripcionHelp': { 'es': 'Nombre descriptivo de la localidad', 'en': 'Descriptive name of the locality', 'pt': 'Nome descritivo da localidade', 'de': 'Beschreibender Name des Standorts', 'fr': 'Nom descriptif de la localité' },
    'localidad.tipoCapacidades': { 'es': 'Tipo y Capacidades Operativas', 'en': 'Type and Operational Capabilities', 'pt': 'Tipo e Capacidades Operacionais', 'de': 'Typ und operative Fähigkeiten', 'fr': 'Type et capacités opérationnelles' },
    'localidad.tipo': { 'es': 'Tipo de Localidad', 'en': 'Locality Type', 'pt': 'Tipo de Localidade', 'de': 'Standorttyp', 'fr': 'Type de localité' },
    'localidad.tipoHelp': { 'es': 'Define el propósito operativo de esta localidad', 'en': 'Defines the operational purpose of this locality', 'pt': 'Define o propósito operacional desta localidade', 'de': 'Definiert den operativen Zweck dieses Standorts', 'fr': 'Définit le rôle opérationnel de cette localité' },
    'localidad.permiteVentas': { 'es': 'Permite Ventas', 'en': 'Allows Sales', 'pt': 'Permite Vendas', 'de': 'Erlaubt Verkäufe', 'fr': 'Autorise les ventes' },
    'localidad.permiteVentasHelp': { 'es': 'Habilita operaciones de venta en esta localidad', 'en': 'Enables sales operations in this locality', 'pt': 'Habilita operações de venda nesta localidade', 'de': 'Ermöglicht Verkaufsoperationen an diesem Standort', 'fr': 'Active les opérations de vente dans cette localité' },
    'localidad.permiteCompras': { 'es': 'Permite Compras', 'en': 'Allows Purchases', 'pt': 'Permite Compras', 'de': 'Erlaubt Einkäufe', 'fr': 'Autorise les achats' },
    'localidad.permiteComprasHelp': { 'es': 'Habilita recepción de mercancías y compras', 'en': 'Enables goods receiving and purchase operations', 'pt': 'Habilita recebimento de mercadorias e compras', 'de': 'Ermöglicht Wareneingang und Einkaufsoperationen', 'fr': 'Active la réception des marchandises et les achats' },
    'localidad.permiteTransferencias': { 'es': 'Permite Transferencias', 'en': 'Allows Transfers', 'pt': 'Permite Transferências', 'de': 'Erlaubt Umlagerungen', 'fr': 'Autorise les transferts' },
    'localidad.permiteTransferenciasHelp': { 'es': 'Habilita transferencias de inventario', 'en': 'Enables inventory transfers', 'pt': 'Habilita transferências de inventário', 'de': 'Ermöglicht Inventurtransfers', 'fr': 'Active les transferts de stock' },
    'localidad.permiteAjustes': { 'es': 'Permite Ajustes', 'en': 'Allows Adjustments', 'pt': 'Permite Ajustes', 'de': 'Erlaubt Anpassungen', 'fr': 'Autorise les ajustements' },
    'localidad.permiteAjustesHelp': { 'es': 'Habilita ajustes de inventario', 'en': 'Enables inventory adjustments', 'pt': 'Habilita ajustes de inventário', 'de': 'Ermöglicht Bestandsanpassungen', 'fr': 'Active les ajustements de stock' },
    'localidad.requiereControlLotes': { 'es': 'Requiere Control de Lotes', 'en': 'Requires Batch Control', 'pt': 'Requer Controle de Lotes', 'de': 'Erfordert Chargenkontrolle', 'fr': 'Requiert le contrôle des lots' },
    'localidad.requiereControlLotesHelp': { 'es': 'Activa trazabilidad por lotes', 'en': 'Enables batch traceability', 'pt': 'Ativa rastreabilidade por lotes', 'de': 'Aktiviert Chargenrückverfolgbarkeit', 'fr': 'Active la traçabilité par lots' },
    'localidad.requiereNumerosSerie': { 'es': 'Requiere Números de Serie', 'en': 'Requires Serial Numbers', 'pt': 'Requer Números de Série', 'de': 'Erfordert Seriennummern', 'fr': 'Requiert des numéros de série' },
    'localidad.requiereNumerosSerieHelp': { 'es': 'Activa trazabilidad por número de serie', 'en': 'Enables serial number traceability', 'pt': 'Ativa rastreabilidade por número de série', 'de': 'Aktiviert Rückverfolgbarkeit per Seriennummer', 'fr': 'Active la traçabilité par numéro de série' },
    'localidad.selectCuenta': { 'es': 'Seleccione una cuenta', 'en': 'Select an account', 'pt': 'Selecione uma conta', 'de': 'Wählen Sie ein Konto', 'fr': 'Sélectionnez un compte' },
    'localidad.cuentaInventarioHelp': { 'es': 'Cuenta para valoración del inventario', 'en': 'Account used for inventory valuation', 'pt': 'Conta para valorização do inventário', 'de': 'Konto für die Bewertung des Inventars', 'fr': 'Compte pour la valorisation du stock' },
    'localidad.cuentaCostoHelp': { 'es': 'Cuenta para costo de ventas', 'en': 'Account used for cost of sales', 'pt': 'Conta para custo das vendas', 'de': 'Konto für Umsatzkosten', 'fr': 'Compte pour le coût des ventes' },
    'localidad.cuentaVentaHelp': { 'es': 'Cuenta para ingresos por ventas', 'en': 'Account used for sales revenue', 'pt': 'Conta para receitas de vendas', 'de': 'Konto für Umsatzerlöse', 'fr': 'Compte pour les revenus de vente' },
    'localidad.cuentaDevolucionHelp': { 'es': 'Cuenta para devoluciones de ventas', 'en': 'Account used for sales returns', 'pt': 'Conta para devoluções de vendas', 'de': 'Konto für Verkaufsrückgaben', 'fr': 'Compte pour les retours sur ventes' },
    ...
    'producto.values': { 'es': 'Valores', 'en': 'Values', 'pt': 'Valores', 'de': 'Werte', 'fr': 'Valeurs' },
    ...
    'fiscal.option.tipoIdentificadorFiscal.nif': { 'es': 'NIF - Número de Identificación Fiscal', 'en': 'NIF - Tax Identification Number', 'pt': 'NIF - Número de Identificação Fiscal', 'de': 'NIF - Steueridentifikationsnummer', 'fr': 'NIF - Numéro d\'identification fiscale' },
    'fiscal.option.tipoIdentificadorFiscal.cif': { 'es': 'CIF - Código de Identificación Fiscal', 'en': 'CIF - Tax Identification Code', 'pt': 'CIF - Código de Identificação Fiscal', 'de': 'CIF - Steueridentifikationscode', 'fr': 'CIF - Code d\'identification fiscale' },
    'fiscal.option.tipoIdentificadorFiscal.dni': { 'es': 'DNI - Documento Nacional de Identidad', 'en': 'DNI - National Identity Document', 'pt': 'DNI - Documento Nacional de Identidade', 'de': 'DNI - Nationales Ausweisdokument', 'fr': 'DNI - Document national d\'identité' },
    'fiscal.option.tipoIdentificadorFiscal.nie': { 'es': 'NIE - Número de Identidad de Extranjero', 'en': 'NIE - Foreigner Identity Number', 'pt': 'NIE - Número de Identidade de Estrangeiro', 'de': 'NIE - Ausländeridentitätsnummer', 'fr': 'NIE - Numéro d\'identité d\'étranger' },
    'fiscal.option.tipoIdentificadorFiscal.vat': { 'es': 'VAT - Identificador de IVA', 'en': 'VAT - Value Added Tax ID', 'pt': 'VAT - Identificador de IVA', 'de': 'VAT - Umsatzsteuer-ID', 'fr': 'VAT - Identifiant TVA' },
    'fiscal.option.tipoIdentificadorFiscal.rfc': { 'es': 'RFC - Registro Federal de Contribuyentes', 'en': 'RFC - Federal Taxpayer Registry', 'pt': 'RFC - Registro Federal de Contribuintes', 'de': 'RFC - Föderales Steuerregister', 'fr': 'RFC - Registre fédéral des contribuables' },
    'fiscal.option.tipoIdentificadorFiscal.ruc': { 'es': 'RUC - Registro Único de Contribuyentes', 'en': 'RUC - Single Taxpayer Registry', 'pt': 'RUC - Registro Único de Contribuintes', 'de': 'RUC - Einheitliches Steuerregister', 'fr': 'RUC - Registre unique des contribuables' },
    'fiscal.option.tipoIdentificadorFiscal.rut': { 'es': 'RUT - Rol Único Tributario', 'en': 'RUT - Single Tax Role', 'pt': 'RUT - Rol Único Tributário', 'de': 'RUT - Einheitliche Steuerrolle', 'fr': 'RUT - Rôle fiscal unique' },
    'fiscal.option.tipoIdentificadorFiscal.cuit': { 'es': 'CUIT - Clave Única de Identificación Tributaria', 'en': 'CUIT - Unique Tax Identification Code', 'pt': 'CUIT - Chave Única de Identificação Tributária', 'de': 'CUIT - Eindeutiger Steueridentifikationscode', 'fr': 'CUIT - Clé unique d\'identification fiscale' },
    'fiscal.option.tipoIdentificadorFiscal.ssn': { 'es': 'SSN - Número de Seguridad Social', 'en': 'SSN - Social Security Number', 'pt': 'SSN - Número de Segurança Social', 'de': 'SSN - Sozialversicherungsnummer', 'fr': 'SSN - Numéro de sécurité sociale' },
    'fiscal.option.tipoIdentificadorFiscal.ein': { 'es': 'EIN - Número de Identificación del Empleador', 'en': 'EIN - Employer Identification Number', 'pt': 'EIN - Número de Identificação do Empregador', 'de': 'EIN - Arbeitgeber-Identifikationsnummer', 'fr': 'EIN - Numéro d\'identification employeur' },
    'fiscal.option.tipoIdentificadorFiscal.pasaporte': { 'es': 'Pasaporte', 'en': 'Passport', 'pt': 'Passaporte', 'de': 'Reisepass', 'fr': 'Passeport' },
    'fiscal.option.tipoIdentificadorFiscal.otro': { 'es': 'Otro', 'en': 'Other', 'pt': 'Outro', 'de': 'Andere', 'fr': 'Autre' },
    'fiscal.option.regimenFiscal.general': { 'es': 'Régimen General', 'en': 'General Regime', 'pt': 'Regime Geral', 'de': 'Allgemeine Regelung', 'fr': 'Régime général' },
    'fiscal.option.regimenFiscal.simplificado': { 'es': 'Régimen Simplificado', 'en': 'Simplified Regime', 'pt': 'Regime Simplificado', 'de': 'Vereinfachte Regelung', 'fr': 'Régime simplifié' },
    'fiscal.option.regimenFiscal.autonomo': { 'es': 'Autónomo / Profesional', 'en': 'Self-employed / Professional', 'pt': 'Autônomo / Profissional', 'de': 'Selbstständig / Freiberuflich', 'fr': 'Indépendant / Professionnel' },
    'fiscal.option.regimenFiscal.exento': { 'es': 'Exento de IVA', 'en': 'VAT Exempt', 'pt': 'Isento de IVA', 'de': 'Von der MwSt. befreit', 'fr': 'Exonéré de TVA' },
    'fiscal.option.regimenFiscal.exportador': { 'es': 'Exportador', 'en': 'Exporter', 'pt': 'Exportador', 'de': 'Exporteur', 'fr': 'Exportateur' },
    'fiscal.option.regimenFiscal.intracomunitario': { 'es': 'Intracomunitario (UE)', 'en': 'Intra-community (EU)', 'pt': 'Intracomunitário (UE)', 'de': 'Innergemeinschaftlich (EU)', 'fr': 'Intracommunautaire (UE)' },
    'fiscal.option.regimenFiscal.pequenoContribuyente': { 'es': 'Pequeño Contribuyente (PYME)', 'en': 'Small Taxpayer (SME)', 'pt': 'Pequeno Contribuinte (PME)', 'de': 'Kleinsteuerzahler (KMU)', 'fr': 'Petit contribuable (PME)' },
    'fiscal.option.regimenFiscal.granContribuyente': { 'es': 'Gran Contribuyente', 'en': 'Large Taxpayer', 'pt': 'Grande Contribuinte', 'de': 'Großsteuerzahler', 'fr': 'Grand contribuable' },
    'fiscal.option.regimenFiscal.personaFisica': { 'es': 'Persona Física', 'en': 'Natural Person', 'pt': 'Pessoa Física', 'de': 'Natürliche Person', 'fr': 'Personne physique' },
    'fiscal.option.regimenFiscal.personaJuridica': { 'es': 'Persona Jurídica', 'en': 'Legal Entity', 'pt': 'Pessoa Jurídica', 'de': 'Juristische Person', 'fr': 'Personne morale' },
    'fiscal.option.regimenFiscal.gobierno': { 'es': 'Gobierno', 'en': 'Government', 'pt': 'Governo', 'de': 'Regierung', 'fr': 'Gouvernement' },
    'fiscal.option.regimenFiscal.ong': { 'es': 'ONG / Sin Fines de Lucro', 'en': 'NGO / Nonprofit', 'pt': 'ONG / Sem Fins Lucrativos', 'de': 'NGO / Gemeinnützig', 'fr': 'ONG / Sans but lucratif' },

    // ═══════════════════════════════════════════════════════════════════════════════════════════
    // 15. USUARIOS
    // ═══════════════════════════════════════════════════════════════════════════════════════════
    'usuario.newTitle': { 'es': 'Nuevo Usuario', 'en': 'New User', 'pt': 'Novo Usuário', 'de': 'Neuer Benutzer', 'fr': 'Nouvel utilisateur' },
    'usuario.editTitle': { 'es': 'Editar Usuario', 'en': 'Edit User', 'pt': 'Editar Usuário', 'de': 'Benutzer bearbeiten', 'fr': 'Modifier utilisateur' },
    'usuario.formSubtitle': { 'es': 'Datos de acceso y permisos', 'en': 'Access data and permissions', 'pt': 'Dados de acesso e permissões', 'de': 'Zugangsdaten und Berechtigungen', 'fr': 'Données d\'accès et permissions' },
    'usuario.listSubtitle': { 'es': 'Gestione los usuarios del sistema', 'en': 'Manage system users', 'pt': 'Gerencie os usuários do sistema', 'de': 'Systembenutzer verwalten', 'fr': 'Gérer les utilisateurs du système' },
    'usuario.detailTitle': { 'es': 'Detalle de Usuario', 'en': 'User Details', 'pt': 'Detalhes do Usuário', 'de': 'Benutzerdetails', 'fr': 'Détail de l\'utilisateur' },
    'usuario.detailSubtitle': { 'es': 'Información completa del usuario', 'en': 'Complete user information', 'pt': 'Informações completas do usuário', 'de': 'Vollständige Benutzerinformationen', 'fr': 'Informations complètes de l\'utilisateur' },
    'usuario.searchPlaceholder': { 'es': 'Buscar por usuario, nombre o email...', 'en': 'Search by username, name or email...', 'pt': 'Buscar por usuário, nome ou e-mail...', 'de': 'Nach Benutzername, Name oder E-Mail suchen...', 'fr': 'Rechercher par utilisateur, nom ou e-mail...' },
    'usuario.confirmDelete': { 'es': '¿Está seguro que desea eliminar al usuario "{0}"?', 'en': 'Are you sure you want to delete user "{0}"?', 'pt': 'Tem certeza de que deseja excluir o usuário "{0}"?', 'de': 'Möchten Sie den Benutzer "{0}" wirklich löschen?', 'fr': 'Voulez-vous vraiment supprimer l\'utilisateur "{0}" ?' },
    'usuario.userName': { 'es': 'Nombre de usuario', 'en': 'Username', 'pt': 'Nome de usuário', 'de': 'Benutzername', 'fr': 'Nom d\'utilisateur' },
    'usuario.fullName': { 'es': 'Nombre completo', 'en': 'Full name', 'pt': 'Nome completo', 'de': 'Vollständiger Name', 'fr': 'Nom complet' },
    'usuario.email': { 'es': 'Email', 'en': 'Email', 'pt': 'E-mail', 'de': 'E-Mail', 'fr': 'E-mail' },
    'usuario.roles': { 'es': 'Roles', 'en': 'Roles', 'pt': 'Papéis', 'de': 'Rollen', 'fr': 'Rôles' },
    'usuario.permissions': { 'es': 'Permisos ERP', 'en': 'ERP permissions', 'pt': 'Permissões ERP', 'de': 'ERP-Berechtigungen', 'fr': 'Autorisations ERP' },
    'usuario.accessLevels': { 'es': 'Niveles de acceso', 'en': 'Access levels', 'pt': 'Níveis de acesso', 'de': 'Zugriffsebenen', 'fr': 'Niveaux d\'accès' },
    'usuario.provider': { 'es': 'Proveedor', 'en': 'Provider', 'pt': 'Provedor', 'de': 'Anbieter', 'fr': 'Fournisseur' },
    'usuario.localProvider': { 'es': 'Local', 'en': 'Local', 'pt': 'Local', 'de': 'Lokal', 'fr': 'Local' },
    'usuario.useEmailAsUsername': { 'es': 'Usar email como nombre de usuario', 'en': 'Use email as username', 'pt': 'Usar e-mail como nome de usuário', 'de': 'E-Mail als Benutzername verwenden', 'fr': 'Utiliser l\'e-mail comme nom d\'utilisateur' },
    'usuario.authProvider': { 'es': 'Proveedor de autenticación', 'en': 'Authentication provider', 'pt': 'Provedor de autenticação', 'de': 'Authentifizierungsanbieter', 'fr': 'Fournisseur d\'authentification' },
    'usuario.password': { 'es': 'Contraseña', 'en': 'Password', 'pt': 'Senha', 'de': 'Passwort', 'fr': 'Mot de passe' },
    'usuario.newPassword': { 'es': 'Nueva contraseña', 'en': 'New password', 'pt': 'Nova senha', 'de': 'Neues Passwort', 'fr': 'Nouveau mot de passe' },
    'usuario.confirmPassword': { 'es': 'Confirmar contraseña', 'en': 'Confirm password', 'pt': 'Confirmar senha', 'de': 'Passwort bestätigen', 'fr': 'Confirmer le mot de passe' },
    'usuario.passwordMinLength': { 'es': 'Mínimo 8 caracteres', 'en': 'Minimum 8 characters', 'pt': 'Mínimo 8 caracteres', 'de': 'Mindestens 8 Zeichen', 'fr': 'Minimum 8 caractères' },
    'usuario.passwordsDoNotMatch': { 'es': 'Las contraseñas no coinciden', 'en': 'Passwords do not match', 'pt': 'As senhas não coincidem', 'de': 'Passwörter stimmen nicht überein', 'fr': 'Les mots de passe ne correspondent pas' },
    'usuario.googlePasswordInfo': { 'es': 'Para usuarios Google no es necesario definir contraseña al crearlo.', 'en': 'For Google users, password is not required at creation time.', 'pt': 'Para usuários Google não é necessário definir senha ao criar.', 'de': 'Für Google-Benutzer ist beim Erstellen kein Passwort erforderlich.', 'fr': 'Pour les utilisateurs Google, il n\'est pas nécessaire de définir un mot de passe à la création.' },
    'usuario.selectAtLeastOneRole': { 'es': 'Seleccione al menos un rol', 'en': 'Select at least one role', 'pt': 'Selecione ao menos um papel', 'de': 'Wählen Sie mindestens eine Rolle aus', 'fr': 'Sélectionnez au moins un rôle' },
    'usuario.selectAtLeastOnePermission': { 'es': 'Seleccione al menos un permiso ERP', 'en': 'Select at least one ERP permission', 'pt': 'Selecione ao menos uma permissão ERP', 'de': 'Wählen Sie mindestens eine ERP-Berechtigung aus', 'fr': 'Sélectionnez au moins une autorisation ERP' },
    'usuario.accessLevelsLabel': { 'es': 'Niveles de acceso (claim accessLevel)', 'en': 'Access levels (accessLevel claim)', 'pt': 'Níveis de acesso (claim accessLevel)', 'de': 'Zugriffsebenen (Claim accessLevel)', 'fr': 'Niveaux d\'accès (claim accessLevel)' },
    'usuario.accessLevelsPlaceholder': { 'es': 'Ej: *, CHK, CHK001', 'en': 'Ex: *, CHK, CHK001', 'pt': 'Ex: *, CHK, CHK001', 'de': 'Bsp: *, CHK, CHK001', 'fr': 'Ex: *, CHK, CHK001' },
    'usuario.accessLevelsHelp': { 'es': 'Prefijos separados por coma.', 'en': 'Comma-separated prefixes.', 'pt': 'Prefixos separados por vírgula.', 'de': 'Durch Kommas getrennte Präfixe.', 'fr': 'Préfixes séparés par des virgules.' },
    'usuario.errorLoading': { 'es': 'Error al cargar usuario', 'en': 'Error loading user', 'pt': 'Erro ao carregar usuário', 'de': 'Fehler beim Laden des Benutzers', 'fr': 'Erreur lors du chargement de l\'utilisateur' },
    'usuario.errorSaving': { 'es': 'Error al guardar usuario', 'en': 'Error saving user', 'pt': 'Erro ao salvar usuário', 'de': 'Fehler beim Speichern des Benutzers', 'fr': 'Erreur lors de l\'enregistrement de l\'utilisateur' },
    ...
    'validation.exactLength': { 'es': 'Debe tener exactamente {0} caracteres', 'en': 'Must be exactly {0} characters long', 'pt': 'Deve ter exatamente {0} caracteres', 'de': 'Muss genau {0} Zeichen lang sein', 'fr': 'Doit contenir exactement {0} caractères' },
