...
namespace GoldBusiness.Domain.Entities
{
    public class Proveedor : BaseEntity
    {
        ...
        public Proveedor(string codigo, string descripcion, string creadoPor)
        {
            SetCodigo(codigo);
        ...
        {
            if (Cancelado)
                throw new DomainException("El proveedor ya está cancelado.");
        ...
        {
            if (!Cancelado)
                throw new DomainException("El proveedor no está cancelado.");
