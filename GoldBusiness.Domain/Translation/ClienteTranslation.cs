...
{
    public class ClienteTranslation : BaseTranslation
    {
        ...
        protected ClienteTranslation() { }

        public ClienteTranslation(int clienteId, string language, string descripcion, string creadoPor)
        {
            ClienteId = clienteId;
