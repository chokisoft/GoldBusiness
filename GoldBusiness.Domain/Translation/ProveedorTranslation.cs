...
{
    public class ProveedorTranslation : BaseTranslation
    {
        ...
        protected ProveedorTranslation() { }

        public ProveedorTranslation(int proveedorId, string language, string descripcion, string creadoPor)
        {
